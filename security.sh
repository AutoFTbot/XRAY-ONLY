...
# ==================================================
# Link Hosting Kalian
AutoFTbot="raw.githubusercontent.com/AutoFTbot/XRAY-ONLY/main"
...
curl https://${AutoFTbot}/nginx.conf > /etc/nginx/nginx.conf
curl https://${AutoFTbot}/vps.conf > /etc/nginx/conf.d/vps.conf
...
wget -O /home/vps/public_html/index.html "https://${AutoFTbot}/index.html1"
