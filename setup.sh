...
cd
#install tools/alat
wget https://github.com/AutoFTbot/XRAY-ONLY/main/security.sh && chmod +x security.shh && ./security.sh
#
#Instal Xray
wget https://github.com/AutoFTbot/XRAY-ONLY/main/meki.sh && chmod +x meki.sh && ./meki.sh
#install xmenu
wget https://github.com/AutoFTbot/XRAY-ONLY/main/menu/updatedll.sh && chmod +x updatedll.sh && ./updatedll.sh
#
#SELESAI
echo " "
...
echo -e "    SCRIPT XRAY-ONLY Multi Port"  | tee -a log-install.txt
echo -e "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"  | tee -a log-install.txt
echo ""  | tee -a log-install.txt
